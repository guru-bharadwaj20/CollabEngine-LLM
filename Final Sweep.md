...
| 1.15 | README reproduces the headline end-to-end | ✅ | Corpus regenerated from nothing (450 episodes, seeds 1000-1149); `fetch_corpus.py` packs/verifies it by manifest and sha256; `gate_report` tells a fresh clone what to do instead of printing nothing; a 40-episode slice + golden file make the analysis path testable in CI. **The rebuild found a fourth arm-asymmetric artifact** — LOG 4.24 |
